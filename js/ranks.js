const RANKS = {
    ...
    desc: {
        rank: {
            ...
            2: "unlock mass upgrade 2, reduce mass upgrade 1 cost scaling by 20%.",
            3: "unlock mass upgrade 3, reduce mass upgrade 2 cost scaling by 20%, mass upgrade 1 boosts itself.",
            4: "reduce mass upgrade 3 cost scaled by 20%.",
            5: "mass upgrade 2 boosts itself.",
            6: "multiply mass gain by (x+1)^2, where x is rank.",
            13: "triple mass gain.",
            ...
            45: "ranks boost Rage Powers gain.",
        ...
        tier: {
            ...
            3: "reduce all mass upgrades cost scaling by 20%.",
            4: "add +5% tickspeed power for every tier you have, softcaps at +40%.",
            6: "rage powers are booster by tiers.",
            8: "make tier 6 reward effect stronger by dark matter.",
            12: "make tier 4 reward effect twice as effective and remove softcap.",
        },
        tetr: {
            1: "reduce tier reqirements by 25%, make Hyper Rank scaling 15% weaker.",
